...
from typing import Type, Generator, Tuple, Optional, Final, Dict, List
    

Instance = Type['Instance']  # cannot import from boto3
_FILTERS: Final[Dict[str, str]] = dict(
...
class InstanceMapping(Mapping):
    ...
    def _get_instances(self, filters: Optional[List[Dict[str, List[str]]]] = None) -> Generator[Instance, None, None]:
        instances = self._client.describe_instances(**(filters if filters else self._filters))
